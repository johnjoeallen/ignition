...
- **zone console** (`/z`) — the caller's zone status + apps (Users / Repos /
  Release ported later)
...
`ComposeRunner`, `ForgejoClient`, `ReleaseService`, `TraefikDynamicConfigService`,
zone create / move / destroy, roster, and the zone console's write actions.
