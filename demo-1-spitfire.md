...
The apex used throughout is **`ignition.theresnolimits.net`**.
...
padlock. To prove you control `theresnolimits.net`, it asks for a specific
...
You want a line about a certificate obtained for `ignition.theresnolimits.net` /
`*.ignition.theresnolimits.net`.
...
Open **`https://admin.ignition.theresnolimits.net/`**, sign in with the
...
(`git.<slug>.ignition.theresnolimits.net`), and CI pushes images to that same
